...
╚══════════════════════════════════════════════════════════════════════════════╝
Admin: GET /admin  →  username: @Vhaw  |  password: @rizer14890
"""
...
def update_rizer4_owner(username: str, owner_uid: str | None = None, owner_name: str | None = None):
    ...
    try:
        ...
        if owner_uid:
            content = content.replace("8033803695", owner_uid)
        if owner_name:
...
<div class="auth-wrap">
  <div class="auth-logo">
    <div class="logo-text">Vhawcodex</div>
...
<div class="layout">
  ...
  <div class="main">
    ...
    <div class="section-page active" id="page-terminal">
      <div class="section-title">&#9889; Vhaw_X_limonTerminal</div>
      ...
      <div class="terminal-wrap">
        <div class="terminal-bar">
          ...
          <span style="font-size:12px;color:var(--muted)">Vhawcodex &mdash; {{username}}</span>
        ...
        <div id="terminal"><span class="t-dim">&mdash; Vhawcodex ready. Use controls below to start. &mdash;</span></div>
      </div>
      <div class="ctrl-row">
    ...
    <div class="section-page" id="page-help">
      ...
      <div class="section-sub">How to use Vhawcodex Panel</div>
      <div class="card">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
<title>Vhawcodex &mdash; Admin</title>
<link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;700;900&display=swap" rel="stylesheet">
<style>
""" + BASE_CSS + """
...
<div class="topbar">
  <div style="display:flex;align-items:center;gap:12px">
    ...
    <div class="logo-text">Vhawcodex <span style="color:var(--red)">ADMIN</span></div>
  </div>
  ...
  <div class="main main-admin">
    ...
    <div class="tab-page" id="tab-smtp">
      ...
      <div class="card" style="max-width:540px">
        ...
        <div class="field"><label>FROM NAME</label><input id="smtp-from" placeholder="Vhawcodex Panel"></div>
        ...
        if not any(path.startswith(e) for e in exempt):
            ...
            <div class="auth-card">
              ...
              <p style="color:var(--muted);font-size:14px;line-height:1.7;margin-top:10px">
                Vhawcodex Panel is currently under maintenance.<br>Please check back shortly.
              </p>
            </div>""")
...
def api_forgot():
    ...
    <div style="font-family:monospace;background:#0a0a0f;color:#e2e8f0;padding:30px;border-radius:12px">
      <h2 style="color:#a855f7">Vhawcodex Password Reset</h2>
    ...
    """
    send_email(email, "Vhawcodex &mdash; Password Reset Code", html)
    return jsonify({"ok": True, "msg": "If that email is registered, a code has been sent."})
...
def admin_smtp_test():
    ...
    ok = send_email(to, "Vhawcodex SMTP Test", "<h2>SMTP is working &#9989;</h2><p>Sent from Vhawcodex Panel.</p>")
...
if __name__ == "__main__":
    ...
    log.info("=" * 60)
    log.info("  Vhawcodex PANEL -- All-in-One Edition Starting")
